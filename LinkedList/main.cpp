...
int main(int argc, char* argv[])
{
	...
	//////Base a(1, "Волженский", "3", "4", "5", "6", "", "прототипы функций, выполняющих операции над отдельными");
	//Base b(2, "Сушко", "3", "4", "5", "6", "", "количество элементов списка");
	//Base c(3, "Кияшко", "3", "4", "5", "6", "", "прототипы функций, выполняющих операции над списком в целом");
	//Base d(4, "Харитонов", "3", "4", "5", "6", "", "пузырьковая сортировка для списка");
	//Base e(5, "Панов", "3", "4", "5", "6", "", "Какая-то строка");
	//BaseList sub;
	//sub.Add(&a);
	//sub.Add(&b);
	//sub.Add(&c);
